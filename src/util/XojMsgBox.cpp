...
void XojMsgBox::showPluginMessage(const std::string& pluginName, const std::string& msg, bool error) {
    auto header = std::string("Scriblark Plugin «") + pluginName + "»";
...
auto XojMsgBox::askPluginQuestion(const std::string& pluginName, const std::string& msg,
    ...
    header += (error ? std::string("<b>Error in </b>") : "") + std::string("Scriblark Plugin «") + pluginName + "»";
...
constexpr auto* XOJ_HELP = "https://scriblark.trieflow.com/support";
