...
void XojMsgBox::showPluginMessage(const std::string& pluginName, const std::string& msg, bool error) {
    auto header = std::string("InkQuay Plugin «") + pluginName + "»";
...
auto XojMsgBox::askPluginQuestion(const std::string& pluginName, const std::string& msg,
    ...
    header += (error ? std::string("<b>Error in </b>") : "") + std::string("InkQuay Plugin «") + pluginName + "»";
...
constexpr auto* XOJ_HELP = "https://inkquay.trieflow.com/support";
