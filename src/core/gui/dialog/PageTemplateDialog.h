...
private:
    void reloadPresets();
    void refreshPresets(const std::string& selected = "");
    void managePreset(int action);
...
private:
    ...
    PageTemplateLibrary* library;
    GtkComboBoxText* presetSelector;
    GtkEntry* presetName;
    GtkLabel* presetError;
    GtkWidget *presetActions, *presetRename, *presetDelete;
