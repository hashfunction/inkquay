...
void addFilterXopp(GtkFileChooser* fc) { addMimeTypeFilter(fc, _("Scriblark files"), "application/x-xopp"); }
void addFilterXopt(GtkFileChooser* fc) { addMimeTypeFilter(fc, _("Scriblark template"), "application/x-xopt"); }
