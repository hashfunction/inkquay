...
void addFilterXopp(GtkFileChooser* fc) { addMimeTypeFilter(fc, _("InkQuay files"), "application/x-xopp"); }
void addFilterXopt(GtkFileChooser* fc) { addMimeTypeFilter(fc, _("InkQuay template"), "application/x-xopt"); }
